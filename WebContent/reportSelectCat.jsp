...
<html>
   ...
   <body>
      <div class="container">
         ...
         <div class="col-sm-10">
            <div class="jumbotron">
               <h3>Add your item category here</h3>
            </div>
            <hr>
            <div class="well">
               <s:form action="AdvertisementCostAction" align="center" >
                  <table>
                     <tr>
                        <td> Category</td>
                        <td>
                           <s:select list="categoryList" id="categoryId" name="categoryId"
                              ...
                              headerKey="0" headerValue="Select Category "></s:select>
                           <script type="text/javascript">
                        ...
                        <td>
                           <div class="col-sm-10">
                              <s:select list="subCatList" name="subCatId" id="subCatId"
                                 listKey="subCatName" listValue="subCatId" 
